const events = [
  ...
  { date: 'Jan 2026', text: 'Goes viral. 160k GitHub stars in weeks', dot: true },
  { date: 'Feb 2026', text: '250k stars. Karpathy: "sci-fi takeoff-adjacent"', dot: true },
  ...
  return (
    <div style={S}>
      <div style={{ fontFamily: 'var(--serif)', fontSize: 48, fontWeight: 700, color: 'var(--warm-headline)', lineHeight: 1.1, marginBottom: 56 }}>
        It started as a<br />one-hour hack
      </div>
